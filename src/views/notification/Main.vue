        ...
        <div class="p-5">
          <Preview>
            <div class="text-center">
              ...
              <!-- END: Notification Content -->
              <!-- BEGIN: Notification Toggle -->
              <button class="btn btn-primary" @click="notificationWithActionsToggle">
                Show Notification
              </button>
              <!-- END: Notification Toggle -->
            </div>
        ...
        <div class="p-5">
          <Preview>
            <div class="text-center">
              ...
              <!-- END: Notification Content -->
              <!-- BEGIN: Notification Toggle -->
              <button class="btn btn-primary" @click="notificationWithAvatarToggle">
                Show Notification
              </button>
              <!-- END: Notification Toggle -->
            </div>
        ...
        <div class="p-5">
          <Preview>
            <div class="text-center">
              ...
              <!-- END: Notification Content -->
              <!-- BEGIN: Notification Toggle -->
              <button class="btn btn-primary" @click="notificationWithSplitButtonsToggle">
                Show Notification
              </button>
              <!-- END: Notification Toggle -->
            </div>
        ...
        <div class="p-5">
          <Preview>
            <div class="text-center">
              ...
              <!-- END: Notification Content -->
              <!-- BEGIN: Notification Toggle -->
              <button class="btn btn-primary" @click="notificationWithButtonsBelowToggle">
                Show Notification
              </button>
              <!-- END: Notification Toggle -->
            </div>
