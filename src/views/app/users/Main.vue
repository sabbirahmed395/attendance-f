        ...
        <table class="table table-report -mt-2">
          <thead>
            <tr>
              ...
              <th class="whitespace-nowrap">STUDENT EMAIL</th>
          ...
          <tbody>
            <tr v-for="(user, k) in users" :key="k" class="intro-x">
              ...
              <td class="font-medium whitespace-nowrap">{{ user.mobile }}</td>
              <td class="font-medium whitespace-nowrap">{{ user.gender }}</td>
              <td class="font-medium whitespace-nowrap">{{ user.status }}</td>
              <td class="font-medium whitespace-nowrap">{{ user.user_type }}</td>
