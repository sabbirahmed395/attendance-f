    ...
    <div class="col-span-12 lg:col-span-4 2xl:col-span-3 flex lg:block flex-col-reverse">
      <div class="intro-y box mt-5">
            ...
            <DropdownMenu class="w-56">
              <DropdownContent>
                ...
                <DropdownItem>
                  ...
                  Indonesia
                  <div class="text-xs text-white px-1 rounded-full bg-danger ml-auto">
                    10
                  </div>
                </DropdownItem>
                <DropdownItem>
                ...
                <DropdownFooter>
                  ...
                  <button type="button" class="btn btn-secondary py-1 px-2 ml-auto">
                    View Profile
                  </button>
                </DropdownFooter>
              </DropdownContent>
        ...
        <div class="p-5 border-t border-slate-200/60 dark:border-darkmode-400 flex">
          ...
          <button type="button" class="btn btn-outline-secondary py-1 px-2 ml-auto">
            New Quick Link
          </button>
        </div>
      </div>
              ...
              <div class="grid grid-cols-12 gap-x-5">
                <div class="col-span-12 2xl:col-span-6">
                  ...
                  <div class="mt-3">
                    ...
                    >
                    <TomSelect id="update-profile-form-2" v-model="select" class="w-full">
                ...
                <div class="col-span-12 2xl:col-span-6">
                  <div class="mt-3 2xl:mt-0">
                    <label for="update-profile-form-3" class="form-label"
                      >Postal Code</label
                    >
                    <TomSelect id="update-profile-form-3" v-model="select" class="w-full">
